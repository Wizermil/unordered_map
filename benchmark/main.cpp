...
using wiz_flat_rob = wiz::robin_hood::node_hash_map<int, int, wiz::hash<int>, wiz::equal_to<int>>;
using wiz_flat_lin = wiz::linear_probing::node_hash_map<int, int, wiz::hash<int>, wiz::equal_to<int>>;
...
#pragma clang diagnostic ignored "-Wglobal-constructors"
    ...
    BENCHMARK_TEMPLATE(modifiers_insert_test, wiz_flat_rob)->Arg(107);
